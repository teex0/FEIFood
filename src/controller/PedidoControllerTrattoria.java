...
public class PedidoControllerTrattoria {
    private Trattoria telaElcacto;

    public PedidoControllerTrattoria(Trattoria tela) {
        this.telaElcacto = tela;
    }

    public void vListarAlimento() {
        AlimentoDAO dao = new AlimentoDAO();
        List<Alimento> itens = dao.buscarPorRestaurante("La Nonna Trattoria");
