...
public class PedidoControllerSushi {
    private Sushi telaElcacto;

    public PedidoControllerSushi(Sushi tela) {
        this.telaElcacto = tela;
    }

    public void vListarAlimento() {
        AlimentoDAO dao = new AlimentoDAO();
        List<Alimento> itens = dao.buscarPorRestaurante("Satorii Sushi");
