...
public class Burger extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Burger.class.getName());
    private PedidoControllerBurger controlePedido;
    /**
     * Creates new form Burger
     */
    public Burger() {
        initComponents();
        this.controlePedido = new PedidoControllerBurger(this);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/burguer.png"))); // NOI18N
        jLabel1.setText("             Route 66 Burguer");
