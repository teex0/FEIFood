 ...
 * @author robotica
 */
public class Deserto extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Deserto.class.getName());

    /**
     * Creates new form Deserto
     */
    public Deserto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/deserto.png"))); // NOI18N
        jLabel1.setText("             Sabores Do Deserto");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Deserto().setVisible(true));
    }
