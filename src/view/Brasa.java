 ...
 * @author robotica
 */
public class Brasa extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Brasa.class.getName());

    /**
     * Creates new form Brasa
     */
    public Brasa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/brasa e alma.png"))); // NOI18N
        jLabel1.setText("             Brasa & Alma");
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Brasa().setVisible(true));
    }
